    ...
    <form class="w-full max-w-sm">
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input
            ...
            placeholder="Name"
          />
          <p v-if="showNameError" class="error text-center text-xs">
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input
            v-model="userEmail"
            @focus="toogleError('email')"
            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-cyan-500"
            id="inlineEmail"
            type="email"
            placeholder="example@mail.com"
          />
          <p v-if="showEmailError" class="error text-center text-xs">
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input
            v-model="password"
            @focus="toogleError('pass')"
            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
            id="inlinPassword"
            type="password"
            placeholder="******************"
          />
          <p v-if="showPassLengthError" class="error text-center text-xs">
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input
            ...
            @focus="toogleError('confPass')"
            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
            id="inline-confirm-password"
            type="password"
            placeholder="******************"
          />
          <p v-if="showPassNotMatchError" class="error text-center text-xs">
